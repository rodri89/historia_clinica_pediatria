...
<head>
  ...
  {{ Html::style('css/rodri_style.css') }}
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion fondoNav" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">HCD</div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/listado_pacientes_dia">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/medico_nuevo_paciente">Nuevo</a>
            <a class="collapse-item" href="/medico_actualizar_paciente">Actualizar</a>
            <a class="collapse-item" href="/medico_buscar_paciente">Buscar</a>
          </div>
        </div>
      </li>
      ...
      <!-- Nav Item - Charts -->
      <!--<li class="nav-item">
        <form method="GET" action="{{ route('nuevaconsultapaciente') }}">
              @csrf                           
              <button class="nav-link sinBackground" type="submit">
              <i class="fas fa-fw fa-address-card"></i>
              <span >Nueva</span></button>
        </form> 
      </li> -->

      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="/nueva_consulta_paciente">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h1 class="h3 mb-0 text-gray-800">@yield('title_header','Medico Home')</h1>            
