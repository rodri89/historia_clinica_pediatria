    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion fondoNav" id="accordionSidebar">
      ...
      <div class="sidebar-heading">
        Administrar
          ...
          <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="/admin_nuevo_usuario">
      ...
      <!-- Nav Item - Charts -->
      <li class="nav-item">
        <a class="nav-link" href="/admin_medicos">
          <i class="fas fa-fw fa-address-card"></i>
          <span >Medicos</span></a>
      </li>
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="admin_secretaria">
          <i class="fas fa-fw fa-folder-open"></i>
          <span>Secretarias</span></a>
      </li>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h1 class="h3 mb-0 text-gray-800">@yield('title_header','')</h1>            
